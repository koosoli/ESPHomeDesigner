...
`);return{text:h,usesManualOverride:h.trim()!==e.trim()}}reconcileManualSnippetOverride(e,n){const i=this.normalizeSnippetText(e),o=this.normalizeSnippetText(n),r=this.normalizeSnippetText(this.lastGeneratedYaml);if(!o.trim())return{text:i,usesManualOverride:!1};if(!r.trim())return{text:o,usesManualOverride:!0};if(o.includes(r)){const s=o.replace(r,i);return{text:s,usesManualOverride:s.trim()!==i.trim()}}const a=this.reconcileManualSnippetOverrideBySections(i,o,r);return a?(v.log("[SnippetManager] Falling back to section-based YAML merge after manual edits changed the generated block."),a):o.trim()===i.trim()?{text:i,usesManualOverride:!1}:(v.warn("[SnippetManager] Unable to merge manual YAML override with regenerated snippet; preserving manual YAML verbatim."),{text:o,usesManualOverride:!0})}persistManualYamlOverride(e){if(typeof p?.setManualYamlOverride=="function"){p.setManualYamlOverride(e,{emitStateChange:!1});return}p?.project?.state&&(p.project.state.manualYamlOverride=e)}clearManualYamlOverride(){typeof p?.clearManualYamlOverride=="function"?p.clearManualYamlOverride():p?.project?.state&&(p.project.state.manualYamlOverride=""),this.refreshManualOverrideUi(!1),this.updateSnippetBox()}handleSnippetTextInput(e){this.setSnippetText(e),this.hasPendingManualSnippetChanges=e.trim()!==this.lastGeneratedYaml.trim(),this.hasPendingManualSnippetChanges?this.persistManualYamlOverride(e):this.clearManualYamlOverride(),this.refreshManualOverrideUi(!!this.getPersistedManualYamlOverride()||this.hasPendingManualSnippetChanges),this.isHighlighted&&this.updateHighlightLayer()}init(){this.bindEvents(),this.setupAutoUpdate(),this.setupScrollSync(),this.updateSnippetBox()}bindEvents(){const e=Y("fullscreenSnippetBtn");e&&e.addEventListener("click",()=>{this.openSnippetModal()});const n=Y("snippetFullscreenClose");n&&n.addEventListener("click",()=>{const _=ve("snippetFullscreenModal");_&&_.classList.add("hidden")});const i=Y("importSnippetConfirm");i&&i.addEventListener("click",async()=>{await this.handleImportSnippet()});const o=Y("updateLayoutBtn");o&&o.addEventListener("click",async()=>{const _=o.querySelector(".mdi"),y=_?.className||"";_&&(_.className="mdi mdi-loading mdi-spin"),o.disabled=!0;try{await this.handleUpdateLayoutFromSnippetBox(),_&&(_.className="mdi mdi-check",setTimeout(()=>{_.className=y},1500))}catch{_&&(_.className="mdi mdi-alert-circle-outline",setTimeout(()=>{_.className=y},1500))}finally{o.disabled=!1}});const r=Y("copySnippetBtn");r&&r.addEventListener("click",async()=>{this.copySnippetToClipboard(r)});const a=Y("copyUiYamlBtn");a&&a.addEventListener("click",async()=>{this.copyUiYamlToClipboard(a)});const s=Y("copyLambdaBtn");s&&s.addEventListener("click",async()=>{this.copyLambdaToClipboard(s)});const l=Y("copyOEPLServiceBtn");l&&l.addEventListener("click",()=>{this.copyOEPLServiceToClipboard(l)});const c=Y("copyODPServiceBtn");c&&c.addEventListener("click",()=>{this.copySnippetToClipboard(c)});const d=Y("copyODPPayloadBtn");d&&d.addEventListener("click",async()=>{await this.copyODPPayloadToClipboard(d)});const u=Y("toggleYamlBtn"),h=document.querySelector(".code-panel");u&&h&&(localStorage.getItem("esphome_designer_yaml_collapsed")==="true"&&h.classList.add("collapsed"),u.addEventListener("click",()=>{const y=h.classList.toggle("collapsed");localStorage.setItem("esphome_designer_yaml_collapsed",String(y)),Et(new Event("resize"))}));const g=Y("clearYamlOverrideBtn");g&&g.addEventListener("click",()=>{this.hasPendingManualSnippetChanges=!1,this.clearManualYamlOverride()});const m=Y("toggleHighlightBtn");document.querySelector(".snippet-container"),m&&(document.querySelectorAll(".snippet-container").forEach(_=>{_.classList.toggle("highlighted",this.isHighlighted)}),document.querySelectorAll('[id*="ToggleHighlightBtn"]').forEach(_=>{_.classList.toggle("active",this.isHighlighted)}),m.addEventListener("click",()=>{this.isHighlighted=!this.isHighlighted,localStorage.setItem("esphome_designer_yaml_highlight",String(this.isHighlighted)),document.querySelectorAll(".snippet-container").forEach(_=>{_.classList.toggle("highlighted",this.isHighlighted)}),document.querySelectorAll('[id*="ToggleHighlightBtn"]').forEach(_=>{_.classList.toggle("active",this.isHighlighted)}),this.isHighlighted&&this.updateHighlightLayer()}));const f=ee("snippetBox");f&&f.addEventListener("input",()=>{this.handleSnippetTextInput(f.value)}),H(ti,()=>{this.isHighlighted&&this.updateHighlightLayer()})}setupScrollSync(){const e=ee("snippetBox"),n=ve("highlightLayer");e&&n&&e.addEventListener("scroll",()=>{n.scrollTop=e.scrollTop,n.scrollLeft=e.scrollLeft})}setupAutoUpdate(){N(I.STATE_CHANGED,()=>{this.suppressSnippetUpdate||this.updateSnippetBox()}),N(I.SELECTION_CHANGED,e=>{const n=e&&e.widgetIds?e.widgetIds:[];typeof Fe=="function"&&Fe(n)})}updateHighlightLayer(){if(!this.isHighlighted)return;const e=ee("snippetBox"),n=ve("highlightLayer");if(e&&n){const r=et()?Qe():null;n.innerHTML=this.highlighter.highlight(e.value,r)}const i=ve("snippetFullscreenHighlight"),o=ve("snippetFullscreenContent");if(i&&o){const r=o.querySelector("textarea");if(r){const a=et()?Qe():null;i.innerHTML=this.highlighter.highlight(r.value,a)}}}updateSnippetBox(){if(ee("snippetBox")){this.snippetDebounceTimer&&clearTimeout(this.snippetDebounceTimer);const n=++this.generationCounter;this.snippetDebounceTimer=setTimeout(()=>{if(n!==this.generationCounter||this.suppressSnippetUpdate)return;const i=this.adapter?.constructor?.name||"";Ua(i);const o=this.getPersistedManualYamlOverride();if(this.hasPendingManualSnippetChanges&&!o){v.log("[SnippetManager] Preserving pending YAML edits; skipping auto-regeneration.");return}try{const a=(p?p.selectedWidgetIds:[]).length>1;this.generateCurrentSnippetYaml().then(s=>{if(n!==this.generationCounter)return;const l=this.reconcileManualSnippetOverride(s,o);this.lastGeneratedYaml=s,this.hasPendingManualSnippetChanges=!1,this.setSnippetText(l.text),l.usesManualOverride?this.persistManualYamlOverride(l.text):this.persistManualYamlOverride(""),this.refreshManualOverrideUi(l.usesManualOverride),this.isHighlighted&&this.updateHighlightLayer();const c=p?p.selectedWidgetIds:[];typeof Fe=="function"&&Fe(c)}).catch(s=>{n===this.generationCounter&&(v.error("Error generating snippet via adapter:",s),this.setSnippetText("# Error generating YAML (adapter): "+Te(s)),this.isHighlighted&&this.updateHighlightLayer())})}catch(r){v.error("Error generating snippet:",r),this.setSnippetText("# Error generating YAML: "+Te(r)),this.isHighlighted&&this.updateHighlightLayer()}},50)}}openSnippetModal(){return Va(this)}async handleImportSnippet(){return qa()}async handleUpdateLayoutFromSnippetBox(){return Xa(this)}async copySnippetToClipboard(e){const n=ee("snippetBox");if(!n)return;const i=n.value||"";try{await ke(i),M("Snippet copied to clipboard","success"),Le(e,"Copied!")}catch(o){v.error("Copy failed:",o),M("Unable to copy snippet","error")}}async copyUiYamlToClipboard(e){const n=ee("snippetBox");if(n)try{const i=za(n.value||"");await ke(i),M("UI YAML copied to clipboard","success"),Le(e,"Copied!")}catch(i){v.error("Copy UI YAML failed:",i),M(Te(i)||"Unable to copy UI YAML","error")}}async copyLambdaToClipboard(e){const n=ee("snippetBox");if(!n)return;const i=n.value||"";try{const o=Wa(i);await ke(o),M("Display lambda copied to clipboard","success"),Le(e,"Copied!")}catch(o){v.error("Copy lambda failed:",o),M(Te(o)||"Unable to copy lambda","error")}}async copyOEPLServiceToClipboard(e){const n=ee("snippetBox");if(!n)return;const i=n.value||"";try{const o=JSON.parse(i),r=$a(o,p.settings);await ke(r),M("HA Service call copied!","success"),Le(e,"Copied!",2e3)}catch(o){v.error("Failed to format/copy OEPL service:",o),M("Failed to format service call","error")}}async copyODPPayloadToClipboard(e){const n=ee("snippetBox");if(!n)return;const i=n.value||"";try{const o=Ya(i);await ke(o),M("Payload copied to clipboard","success"),Le(e,"Copied!")}catch(o){v.error("Copy payload failed:",o),M(Te(o)||"Unable to copy payload","error")}}}class J{static _activeHandler=null;static _listenersAttached=!1;static _boundKeyDown=null;constructor(){this._seenKeyEvents=new WeakSet,J._activeHandler=this,this.init()}init(){J._listenersAttached||(J._boundKeyDown=e=>{const n=J._activeHandler;n&&(n._seenKeyEvents.has(e)||(n._seenKeyEvents.add(e),n.handleKeyDown(e)))},typeof document?.addEventListener=="function"&&document.addEventListener("keydown",J._boundKeyDown),H("keydown",J._boundKeyDown),J._listenersAttached=!0)}handleKeyDown(e){const n=p;if(!n){v.error("KeyboardHandler: AppState not found!");return}const i=n.selectedWidgetIds.length>0,o=e.target instanceof HTMLElement?e.target:null,r=J.isInput(o),a=J.hasNativeTextSelection(o);if(e.shiftKey&&e.code==="Space"){o&&J.isInput(o)&&o.blur(),e.preventDefault(),He&&He.open();return}if((e.key==="Delete"||e.key==="Backspace")&&i){if(r)return;e.preventDefault(),this.deleteWidget(null);return}const s={ArrowUp:[0,-1],ArrowDown:[0,1],ArrowLeft:[-1,0],ArrowRight:[1,0]}[e.key];if(s&&i&&!e.ctrlKey&&!e.metaKey&&!e.altKey){if(r)return;const l=e.shiftKey?10:1;e.preventDefault(),this.nudgeSelectedWidgets(s[0]*l,s[1]*l);return}if((e.ctrlKey||e.metaKey)&&e.key&&e.key.toLowerCase()==="c"){if(r||a)return;e.preventDefault(),this.copyWidget();return}if((e.ctrlKey||e.metaKey)&&e.key&&e.key.toLowerCase()==="v"){if(r)return;e.preventDefault(),this.pasteWidget();return}if((e.ctrlKey||e.metaKey)&&e.key&&e.key.toLowerCase()==="z"&&!e.shiftKey){if(r)return;e.preventDefault(),n.isUndoRedoInProgress=!0,n.undo(),setTimeout(()=>{n.isUndoRedoInProgress=!1},100);return}if((e.ctrlKey||e.metaKey)&&e.key&&(e.key.toLowerCase()==="y"||e.key.toLowerCase()==="z"&&e.shiftKey)){if(r)return;e.preventDefault(),n.isUndoRedoInProgress=!0,n.redo(),setTimeout(()=>{n.isUndoRedoInProgress=!1},100);return}if((e.ctrlKey||e.metaKey)&&e.key&&e.key.toLowerCase()==="l"&&i){e.preventDefault();const c=n.getSelectedWidgets().every(d=>d.locked);n.updateWidgets(n.selectedWidgetIds,{locked:!c})}if((e.ctrlKey||e.metaKey)&&e.key&&e.key.toLowerCase()==="a"&&e.target instanceof HTMLElement&&!J.isInput(e.target)&&!a){e.preventDefault(),n.selectAllWidgets();return}if(e.key&&e.key.toLowerCase()==="g"&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&!e.altKey&&e.target instanceof HTMLElement&&e.target.tagName!=="INPUT"&&e.target.tagName!=="TEXTAREA"){e.preventDefault();const l=!n.showGrid;if(n.setShowGrid(l),l){n.setShowDebugGrid(!1);const d=document.getElementById("debugGridToggleBtn");d&&d.classList.remove("active")}const c=document.getElementById("gridToggleBtn");c&&c.classList.toggle("active",l),C(I.STATE_CHANGED),v.log(`[Keyboard] Grid toggled: ${l}`);return}if(e.key&&e.key.toLowerCase()==="d"&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&!e.altKey&&e.target instanceof HTMLElement&&e.target.tagName!=="INPUT"&&e.target.tagName!=="TEXTAREA"){e.preventDefault();const l=!n.showDebugGrid;if(n.setShowDebugGrid(l),l){n.setShowGrid(!1);const d=document.getElementById("gridToggleBtn");d&&d.classList.remove("active")}const c=document.getElementById("debugGridToggleBtn");c&&c.classList.toggle("active",l),C(I.STATE_CHANGED),v.log(`[Keyboard] Debug mode toggled: ${l}`);return}if(e.key&&e.key.toLowerCase()==="r"&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&!e.altKey&&e.target instanceof HTMLElement&&e.target.tagName!=="INPUT"&&e.target.tagName!=="TEXTAREA"){e.preventDefault();const l=!n.showRulers;n.setShowRulers(l);const c=document.getElementById("rulersToggleBtn");c&&c.classList.toggle("active",l),v.log(`[Keyboard] Rulers toggled: ${l}`);return}e.key==="Escape"&&(document.activeElement instanceof HTMLElement&&(document.activeElement.tagName==="INPUT"||document.activeElement.tagName==="TEXTAREA")&&document.activeElement.blur(),n.selectedWidgetIds.length>0&&(n.selectWidgets([]),C(I.STATE_CHANGED)))}static isInput(e){return!!(e instanceof HTMLElement&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable))}static hasNativeTextSelection(e){if(e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement){const n=e.selectionStart??0;return(e.selectionEnd??0)>n}try{const n=globalThis.getSelection?.();return!!n&&!n.isCollapsed&&n.toString().trim().length>0}catch{return!1}}nudgeSelectedWidgets(e,n){const i=p,o=i.getCurrentPage?.(),r=new Set(i.selectedWidgetIds),a=i.getSelectedWidgets(),s=[];for(const h of a)!h||h.locked||(s.push(h),h.type==="group"&&o?.widgets&&s.push(...o.widgets.filter(g=>g.parentId===h.id&&!g.locked&&!r.has(g.id))));if(!s.length)return!1;const l=i.getCanvasDimensions?.()||{},c=Number(l.width)||1/0,d=Number(l.height)||1/0;let u=!1;for(const h of s){const g=Number(h.width)||0,m=Number(h.height)||0,f=Number.isFinite(c)?Math.max(0,c-g):1/0,_=Number.isFinite(d)?Math.max(0,d-m):1/0,y=Number(h.x)||0,b=Number(h.y)||0,S=Math.min(f,Math.max(0,y+e)),w=Math.min(_,Math.max(0,b+n));(S!==h.x||w!==h.y)&&(h.x=S,h.y=w,u=!0)}return u?(typeof i.recordHistory=="function"&&i.recordHistory(),C(I.STATE_CHANGED),!0):!1}deleteWidget(e){const n=p;n&&n.deleteWidget(e)}copyWidget(){const e=p;e&&e.copyWidget()}pasteWidget(){const e=p;e&&e.pasteWidget()}}const Ka=`<header class="main-header" role="banner">
  <div class="main-header-title">
    ...
    <span><small style="opacity: 0.5; margin-left: 8px;">v1.0.0 RC43</small> <span id="currentLayoutDevice"
