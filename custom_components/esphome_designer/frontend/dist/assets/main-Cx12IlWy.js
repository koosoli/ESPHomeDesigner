const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./plugin-CsebdL4D.js","./text_utils-DPZlj6Oi.js","./plugin-Bvmi5kcV.js","./template_converter-Dp-G9w6d.js","./plugin-BUd1JxDA.js","./plugin-DZEpZYYA.js"])))=>i.map(i=>d[i]);
            ...
            <div class="field">
              ...
              <div style="display:flex; flex-direction:column; gap:8px;">
                ...
                <div>
                  ...
                  <input type="text" id="haManualUrl" class="prop-input" autocomplete="off"
                    placeholder="https://your-ha.duckdns.org:8123" />
                </div>
                <div>
                  <div class="prop-label" style="font-size: 10px;">Long-Lived Access Token</div>
                  <input type="password" id="haLlatToken" class="prop-input" autocomplete="off" placeholder="Paste your token here..." />
                </div>
...
`;function $e(n,e){const i=document.getElementById(n);i?i.outerHTML=e:console.warn(`[UI Injection] Placeholder #${n} not found in index.html.`)}function zo(){console.log("[UI Injection] Loading modular UI components..."),$e("header-placeholder",Ho),$e("sidebar-placeholder",Fo),$e("code-panel-placeholder",Go),$e("properties-panel-placeholder",Wo),$e("modals-placeholder",$o),console.log("[UI Injection] Construction complete.")}zo();const Uo="modulepreload",Yo=function(n,e){return new URL(n,e).href},yn={},T=function(e,i,o){let t=Promise.resolve();if(i&&i.length>0){const r=document.getElementsByTagName("link"),a=document.querySelector("meta[property=csp-nonce]"),l=a?.nonce||a?.getAttribute("nonce");t=Promise.allSettled(i.map(c=>{if(c=Yo(c,o),c in yn)return;yn[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(!!o)for(let m=r.length-1;m>=0;m--){const y=r[m];if(y.href===c&&(!d||y.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Uo,d||(u.as="script"),u.crossOrigin="",u.href=c,l&&u.setAttribute("nonce",l),document.head.appendChild(u),d)return new Promise((m,y)=>{u.addEventListener("load",m),u.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=r,window.dispatchEvent(a),!a.defaultPrevented)throw r}return t.then(r=>{for(const a of r||[])a.status==="rejected"&&s(a.reason);return e().catch(s)})},ft=new EventTarget,C={STATE_CHANGED:"state-changed",SELECTION_CHANGED:"selection-changed",PAGE_CHANGED:"page-changed",HISTORY_CHANGED:"history-changed",SETTINGS_CHANGED:"settings-changed",LAYOUT_IMPORTED:"layout-imported",ENTITIES_LOADED:"entities-loaded",ZOOM_CHANGED:"zoom-changed"};function L(n,e={}){ft.dispatchEvent(new CustomEvent(n,{detail:e}))}function q(n,e){ft.addEventListener(n,i=>e(i.detail))}function di(n,e){ft.removeEventListener(n,e)}window.EVENTS=C;window.emit=L;window.on=q;window.off=di;const jo=Object.freeze(Object.defineProperty({__proto__:null,EVENTS:C,EventBus:ft,emit:L,off:di,on:q},Symbol.toStringTag,{value:"Module"})),Vt={WHITE:"#FFFFFF",BLACK:"#000000",GRAY:"#808080",GREY:"#808080",RED:"#FF0000",GREEN:"#00FF00",BLUE:"#0000FF",YELLOW:"#FFFF00",ORANGE:"#FFA500"},ci={GRID_SIZE:10,SNAP_THRESHOLD:10,SIDEBAR_WIDTH:300,PROPERTIES_WIDTH:350},pi={X:40,Y:40,WIDTH:200,HEIGHT:60},qt={TOP_LEFT:"TOP_LEFT",TOP_CENTER:"TOP_CENTER",TOP_RIGHT:"TOP_RIGHT",CENTER_LEFT:"CENTER_LEFT",CENTER:"CENTER",CENTER_RIGHT:"CENTER_RIGHT",BOTTOM_LEFT:"BOTTOM_LEFT",BOTTOM_CENTER:"BOTTOM_CENTER",BOTTOM_RIGHT:"BOTTOM_RIGHT"},Xt={LANDSCAPE:"landscape",PORTRAIT:"portrait"},Kt={snapEnabled:!0,showGrid:!0,showDebugGrid:!1,showRulers:!1,gridOpacity:8,editor_light_mode:!1,aiProvider:"gemini",aiModelGemini:"gemini-1.5-flash",aiModelOpenAI:"gpt-4o",aiModelOpenRouter:"",aiModelFilter:"",extendedLatinGlyphs:!1,autoCycleEnabled:!1,autoCycleIntervalS:30,refreshInterval:600,manualRefreshOnly:!1,darkMode:!1,invertedColors:!1,lcdEcoStrategy:"backlight_off",dimTimeout:10,sleepEnabled:!1,sleepStartHour:0,sleepEndHour:5,deepSleepEnabled:!1,deepSleepInterval:600,dailyRefreshEnabled:!1,dailyRefreshTime:"08:00",noRefreshStartHour:null,noRefreshEndHour:null,renderingMode:"direct",oeplEntityId:"",oeplDither:2,opendisplayEntityId:"",opendisplayDither:2,opendisplayTtl:60,glyphsets:["GF_Latin_Kernel"]},Jt=50,ui={RSS:300,ENTITIES:60},hi=5e3,_e=10,gi=10,Zt={white:"COLOR_WHITE",black:"COLOR_BLACK",gray:"Color(160, 160, 160)",grey:"Color(160, 160, 160)",red:"COLOR_RED",green:"COLOR_GREEN",blue:"COLOR_BLUE",yellow:"COLOR_YELLOW",orange:"COLOR_ORANGE"},Qt=800,en=480;window.ESPHomeDesigner=window.ESPHomeDesigner||{version:"0.9.0",constants:{COLORS:Vt,UI_DEFAULTS:ci,ALIGNMENT:qt,ORIENTATIONS:Xt,DEFAULT_PREFERENCES:Kt,WIDGET_DEFAULTS:pi,HISTORY_LIMIT:Jt,CACHE_TTL:ui,ENTITY_LIMIT:hi,ESPHOME_COLOR_MAPPING:Zt,DEFAULT_CANVAS_WIDTH:Qt,DEFAULT_CANVAS_HEIGHT:en,SNAP_DISTANCE:_e,GRID_SIZE:gi}};window.COLORS=Vt;window.UI_DEFAULTS=ci;window.ALIGNMENT=qt;window.ORIENTATIONS=Xt;window.DEFAULT_PREFERENCES=Kt;window.WIDGET_DEFAULTS=pi;window.HISTORY_LIMIT=Jt;window.CACHE_TTL=ui;window.ENTITY_LIMIT=hi;window.ESPHOME_COLOR_MAPPING=Zt;window.DEFAULT_CANVAS_WIDTH=Qt;window.DEFAULT_CANVAS_HEIGHT=en;window.SNAP_DISTANCE=_e;window.GRID_SIZE=gi;var Vo={};const qo=(typeof localStorage<"u"?localStorage.getItem("esphome-designer-debug"):Vo.DEBUG)==="true"||typeof window<"u"&&new URLSearchParams(window.location.search).get("debug")==="true",b={log:(...n)=>qo&&console.log("[ESPHomeDesigner]",...n),warn:(...n)=>console.warn("[ESPHomeDesigner]",...n),error:(...n)=>console.error("[ESPHomeDesigner]",...n)},Xo=`# ============================================================================
...
display:
  - platform: waveshare_epaper
    ...
    # __LAMBDA_PLACEHOLDER__
`;function tn(){let n=nn();if(n)return n=n.trim(),n.includes("reterminal_dashboard")&&(b.log("[Env] Migrating legacy manual URL to new domain"),n=n.replace("reterminal_dashboard","esphome_designer"),on(n)),n.endsWith("/")&&(n=n.slice(0,-1)),n&&!n.includes("/api/")&&(n+="/api/esphome_designer"),n&&!n.startsWith("http://")&&!n.startsWith("https://")&&!n.startsWith("/")&&(n="/"+n),n;try{const e=window.location;return e.protocol==="file:"?null:e.hostname==="homeassistant"||e.hostname==="hassio"||e.pathname.includes("/api/")||e.pathname.includes("/local/")||e.pathname.includes("/hacsfiles/")||e.pathname.includes("/esphome-designer")?`${e.origin}/api/esphome_designer`:null}catch{return null}}function nn(){try{return localStorage.getItem("ha_manual_url")}catch{return null}}function on(n){try{if(n){let e=n.trim();e.endsWith("/")&&(e=e.slice(0,-1));const i=e.startsWith("http://")||e.startsWith("https://");e.includes("/api/")||(sn()?(b.log("[Env] Detected HA deployment without API path, fixing automatically"),e=`${window.location.origin}/api/esphome_designer`):(e+="/api/esphome_designer",!i&&!e.startsWith("/")&&(e="/"+e))),localStorage.setItem("ha_manual_url",e)}else localStorage.removeItem("ha_manual_url")}catch(e){b.error("Failed to save HA URL:",e)}}function mt(){try{return localStorage.getItem("ha_llat_token")}catch{return null}}function fi(n){try{n?localStorage.setItem("ha_llat_token",n):localStorage.removeItem("ha_llat_token")}catch(e){b.error("Failed to save HA Token:",e)}}let V=tn();function Lt(){V=tn()}function z(){return!!V}function sn(){try{const n=window.location;return n.protocol==="file:"?!1:n.hostname==="homeassistant"||n.hostname==="hassio"||n.pathname.includes("/api/esphome_designer")||n.pathname.includes("/esphome-designer")}catch{return!1}}window.detectHaBackendBaseUrl=tn;window.getHaManualUrl=nn;window.setHaManualUrl=on;window.getHaToken=mt;window.setHaToken=fi;window.HA_API_BASE=V;window.refreshHaBaseUrl=Lt;window.hasHaBackend=z;window.isDeployedInHa=sn;/*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT */function mi(n){return typeof n>"u"||n===null}function cs(n){return typeof n=="object"&&n!==null}function ps(n){return Array.isArray(n)?n:mi(n)?[]:[n]}function us(n,e){var i,o,t,s;if(e)for(s=Object.keys(e),i=0,o=s.length;i<o;i+=1)t=s[i],n[t]=e[t];return n}function hs(n,e){var i="",o;for(o=0;o<e;o+=1)i+=n;return i}function gs(n){return n===0&&Number.NEGATIVE_INFINITY===1/n}var fs=mi,ms=cs,ys=ps,_s=hs,bs=gs,vs=us,K={isNothing:fs,isObject:ms,toArray:ys,repeat:_s,isNegativeZero:bs,extend:vs};function yi(n,e){var i="",o=n.reason||"(unknown reason)";return n.mark?(n.mark.name&&(i+='in "'+n.mark.name+'" '),i+="("+(n.mark.line+1)+":"+(n.mark.column+1)+")",!e&&n.mark.snippet&&(i+=`
...
`).some(J=>J.trim()==="time:"))||(d.push("time:","  - platform: homeassistant","    id: ha_time"),y.add("ha_time")),a.features&&(a.pins?.batteryAdc&&(y.add("battery_voltage"),y.add("battery_level")),a.features.sht4x&&(y.add("sht4x_sensor"),y.add("sht4x_temperature"),y.add("sht4x_humidity")),(a.features.sht3x||a.features.sht3xd)&&(y.add("sht3x_sensor"),y.add("sht3x_temperature"),y.add("sht3x_humidity")),a.features.shtc3&&(y.add("shtc3_sensor"),y.add("shtc3_temperature"),y.add("shtc3_humidity"))),Zn&&d.push(...Zn(a,[],p,u));const N=[];W.onExportNumericSensors({...v,lines:N,mainLines:d});const H=this.processPendingTriggers(N,_,l,"on_value");H.length>0&&(d.some(O=>O==="sensor:")||d.push("sensor:"),d.push(...H.flatMap(O=>O.split(`
...
`).map(F=>"  "+F))));const le=Yl(i,v);if(le.length>0){d.some(F=>F==="binary_sensor:")||d.push("binary_sensor:");const O=this.processPendingTriggers(le,_,l,"on_state");d.push(...O.flatMap(F=>F.split(`
`).map(J=>"  "+J)))}if(!a.isPackageBased&&Qn){const O=Qn(a,i.length,p);O.length>0&&d.push(...O)}const j=W.getAll(),We=["image","online_image","graph","qr_code"];j.sort((O,F)=>{const J=We.indexOf(O.id),Se=We.indexOf(F.id);return J!==-1&&Se!==-1?J-Se:J!==-1?-1:Se!==-1?1:O.id.localeCompare(F.id)}),j.forEach(O=>O.onExportComponents&&O.onExportComponents({...v,lines:d}))}const S=$l(i,e,a,v,this);d.push(...this.fonts.getLines(e.glyphsets,e.extendedLatinGlyphs));const w=this.yaml.generateScriptSection(e,i,a);w.length>0&&d.push(...w);let E=!1;if(l&&ri){const x=ri(i,o,a,e);x&&x.length>0&&(d.push(...x),E=!0)}if(a.isPackageBased){if(h)return Vl(h,S,this._pendingTouchSensors,a,e,l,d)}else{const x=Jn?Jn(a,e,l):[];d.push(...x);for(let I=0;I<d.length;I++)if(d[I].trim()==="display:"){let k=I+1;for(;k<d.length&&(d[k].startsWith("  ")||d[k].trim()==="");)k++;E||d.splice(k,0,"    lambda: |-",...S.map(P=>P.trim()?"      "+P:""));break}}return d.map(x=>x.trimEnd()).join(`
