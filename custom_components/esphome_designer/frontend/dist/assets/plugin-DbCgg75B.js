import{A as N}from"./app-shell-jeCWrafV.js";import"./yaml-engine-D4JkGkgw.js";import"./vendor-Bi4LEBGV.js";const Y=`# Dictionary to map calendar keys to their corresponding names
...
`,O=(t,s,e,{getColorStyle:a})=>{const i=s.width||400,p=s.height||300,u=e.text_color||"theme_auto",n=a(u);if(t.style.width=i+"px",t.style.height=p+"px",t.style.backgroundColor=e.background_color||"transparent",t.style.borderRadius=`${e.border_radius||0}px`,t.style.color=n,t.style.padding="4px",t.style.boxSizing="border-box",e.border_width){const r=e.border_color||u;t.style.border=`${e.border_width}px solid ${a(r)}`}else t.style.border="none";const l=new Date,d=l.getDate(),y=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],v=["January","February","March","April","May","June","July","August","September","October","November","December"],_=y[l.getDay()],S=`${v[l.getMonth()]} ${l.getFullYear()}`,h=document.createElement("div");h.style.textAlign="center",h.style.padding="2px",h.style.borderBottom="1px solid "+n,h.style.flexShrink="0";const T=document.createElement("div");T.style.fontSize=Math.min((e.font_size_date||100)*.7,80)+"px",T.style.fontWeight="100",T.style.lineHeight="0.8",T.innerText=d,h.appendChild(T);const x=document.createElement("div");x.style.fontSize=(e.font_size_day||24)+"px",x.style.fontWeight="bold",x.style.marginTop="4px",x.innerText=_,h.appendChild(x);const E=document.createElement("div");E.style.fontSize=(e.font_size_grid||14)+"px",E.innerText=S,h.appendChild(E),t.style.display="flex",t.style.flexDirection="column",e.show_header!==!1&&t.appendChild(h);const m=document.createElement("div");m.style.display="grid",m.style.gridTemplateColumns="repeat(7, 1fr)",m.style.padding="2px",m.style.gap="1px",m.style.flexShrink="0";const $=(e.font_size_grid||14)+"px";["Mo","Tu","We","Th","Fr","Sa","Su"].forEach(r=>{const o=document.createElement("div");o.innerText=r,o.style.textAlign="center",o.style.fontWeight="bold",o.style.fontSize=$,m.appendChild(o)});const z=new Date(l.getFullYear(),l.getMonth(),1),M=new Date(l.getFullYear(),l.getMonth()+1,0).getDate();let w=z.getDay();w===0&&(w=7),w-=1;for(let r=0;r<w;r++)m.appendChild(document.createElement("div"));for(let r=1;r<=M;r++){const o=document.createElement("div");if(o.innerText=r,o.style.textAlign="center",o.style.fontSize=$,r===d){o.style.backgroundColor=n;const f=e.background_color||"transparent";n==="white"||n==="#ffffff"||n==="#fff"||n.startsWith("rgb(255")||n==="black"||n==="#000000"||n==="#000"||f==="transparent"||a(f),f==="transparent"?o.style.color=n.includes("white")||n.includes("#f")||n.includes("255")?"black":"white":o.style.color=a(f),o.style.borderRadius="50%",o.style.width="1.5em",o.style.height="1.5em",o.style.lineHeight="1.5em",o.style.margin="0 auto",o.style.fontWeight="bold"}m.appendChild(o)}e.show_grid!==!1&&t.appendChild(m);const g=document.createElement("div");g.style.padding="5px",g.style.fontSize=(e.font_size_event||18)+"px",g.style.flexGrow="1",g.style.overflow="hidden";let b=null;const C=(s.entity_id||e.entity_id||"sensor.esp_calendar_data").trim();if(N&&N.entityStates){const r=N.entityStates[C];if(r)try{if(r.attributes&&r.attributes.entries)if(typeof r.attributes.entries=="string"){const o=JSON.parse(r.attributes.entries);b=o.days||o}else b=r.attributes.entries.days||r.attributes.entries;else if(r.state&&r.state.length>5&&r.state!=="OK"&&r.state!=="unknown"){const o=JSON.parse(r.state);b=o.days||o}else if(!b&&r.attributes){const o=r.attributes.message;if(o!==void 0){const f=new Date,A=r.attributes.start_time||"",I=r.attributes.end_time||"",c=r.attributes.all_day===!0;b=[{day:f.getDate(),all_day:c?[{summary:o,start:A,end:I}]:[],other:c?[]:[{summary:o,start:A,end:I}]}]}}}catch(o){console.warn("[Calendar Widget] Failed to parse live state/attributes:",o)}}if(b&&Array.isArray(b)&&b.length>0){g.innerHTML="";const r=parseInt(String(e.max_events||e.event_limit||8),10);let o=0;for(const f of b){if(o>=r)break;const A=f.day,I=(c,H)=>{if(o>=r)return;const W=c.summary||"No Title",P=c.start||"";let R=H?"All Day":"";!H&&P.includes("T")&&(R=P.split("T")[1].substring(0,5));const k=document.createElement("div");k.style.marginBottom="4px",k.style.display="flex",k.style.justifyContent="space-between",k.innerHTML=`<span style="flex-shrink:0;width:25px;"><b>${A}</b></span><span style="flex-grow:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-right:8px;">${W}</span><span style="flex-shrink:0;opacity:0.7;font-size:0.9em;">${R}</span>`,g.appendChild(k),o++};f.all_day&&f.all_day.forEach(c=>I(c,!0)),f.other&&f.other.forEach(c=>I(c,!1))}}else g.innerHTML=`
            <div style="margin-bottom:4px;"><b>${d}</b> Meeting with Team</div>
            <div><b>${Math.min(d+2,M)}</b> Dentist Appointment</div>
        `;e.show_events!==!1&&t.appendChild(g)},B={id:"calendar",name:"Calendar",category:"Events",supportedModes:["lvgl","direct"],defaults:{entity_id:"sensor.esp_calendar_data",border_width:0,show_border:!0,border_color:"theme_auto",border_radius:0,background_color:"transparent",text_color:"theme_auto",font_size_date:100,font_size_day:24,font_size_grid:14,font_size_event:18,show_header:!0,show_grid:!0,show_events:!0,width:335,height:340,opa:255},renderProperties:(t,s)=>{const e=s.props||{},a=(n,l)=>{const d={...s.props,[n]:l};N.updateWidget(s.id,{props:d})};t.createSection("Data Source",!0),t.addLabeledInputWithPicker("Calendar Sensor ID","text",s.entity_id||"sensor.esp_calendar_data",n=>{N.updateWidget(s.id,{entity_id:n})},s),t.addLabeledInput("Source Calendars (CSV)","text",e.source_calendars||"calendar.example_1, calendar.example_2",n=>a("source_calendars",n)),t.addHint("List the HA calendar entities to include, separated by commas.");const i=document.createElement("div");i.style.display="flex",i.style.gap="8px",i.style.marginTop="12px";const p=document.createElement("button");p.className="btn btn-secondary btn-full btn-xs",p.textContent="Script",p.title="Download Python Helper Script",p.style.flex="1",p.addEventListener("click",()=>{const n=document.createElement("a");n.setAttribute("href","data:text/x-python;charset=utf-8,"+encodeURIComponent(Y)),n.setAttribute("download","esp_calendar_data_conversion.py"),n.click()});const u=document.createElement("button");u.className="btn btn-secondary btn-full btn-xs",u.textContent="YAML",u.title="Copy HA Template YAML to Clipboard",u.style.flex="1",u.addEventListener("click",()=>{const n=`
