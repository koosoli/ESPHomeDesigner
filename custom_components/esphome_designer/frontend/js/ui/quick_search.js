...
export class QuickSearch {
    ...
    discoverWidgets() {
        ...
        if (items.length === 0) {
            Logger.warn("[QuickSearch] No widgets found in palette");
            return;
        }
        ...
        Logger.log(`[QuickSearch] Discovered ${this.allWidgets.length} widgets`);
    }
    ...
    addSelectedWidget() {
        ...
        try {
            ...
            Logger.log(`[QuickSearch] Added widget: ${widget.label}`);
            this.close();
        } catch (err) {
